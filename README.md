...
<pre>
  ...
  If you don't know how to redirect traffic to docker interface, this command allow the container a full access to host <p> network interfaces, but you have to change the name of network interface from run.sh script (eth0 to your name interface)
